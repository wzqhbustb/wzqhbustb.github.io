---
layout: post
title: "18.6 tok/s on an M3 Max: Building a Qwen3 Inference Engine from Scratch in Metal"
description: "A deep dive into qw3, a minimal native Metal inference engine for Qwen3-30B-A3B on Apple Silicon — covering mmap zero-copy loading, overlapped decode scheduling, gathered MoE, and the RoPE bug that taught us a lesson."
date: 2026-06-18
categories: [tech]
tags: [qwen3, metal, inference, llm, apple-silicon, moe, gguf, quantization]
---
